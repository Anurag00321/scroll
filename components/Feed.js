    ...
    <div className="items-center">
      {posts.map((post) => (
        <div
          key={post.id}
          href="#"
          className="h-fit cursor-pointer border-b border-gray-200"
        >
          <div className="px-4 z-50 p-4 md:p-8 h-fit cursor-pointer">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <button
                    ...
                    className="bg-white mx-2 p-1 hover:bg-gray-100 rounded-lg"
                  >
                    <svg
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="my-4 mx-12 text-green-500 hover:underline"
            >
              {post.url}
            </a>
          </div>
            ...
            <a href={post.url} target="_blank" rel="noreferrer">
              <div className="rounded justify-between  p-2 w-fit lg:w-[580px] flex border bg-gray-100 h-fit lg:ml-16 border-gray-200 mx-6 ">
                <div className="items-start">
                  ...
                  <p className="text-gray-700 text-sm">{post.type}</p>{" "}
                  {post.company}
                </div>
                <div>
